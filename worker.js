...
async function processRequest(windowType, customFrom, customTo, env) {
  ...
  // Tile #1 — Filter cohortDeals (already-fetched 4-month sliding window) by
  // hs_createdate in the prior calendar month and date_demo_booked on or after.
  try {
    const _now = new Date();
    ...
    let cohortConsidered = 0, createdInPcm = 0, noDemoExcluded = 0, demoBeforeCreateExcluded = 0;
